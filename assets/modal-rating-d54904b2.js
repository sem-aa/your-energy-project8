...
<div class="gif-container"><img src='${h}' alt="${s} gif"/>
    ...
    <svg
          ...
          </svg>`,b(C);return}U(e._id),t.innerHTML=`Add to favorites
          <svg
