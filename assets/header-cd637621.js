...
<div class="gif-container"><img src='${l}' alt="${r} gif"/>
    ...
    </li>`},E=t=>t.results.map(({imgURL:e,name:r,filter:o})=>(e||(e="/images/no-image.png"),`            
      ...
      </li>`)).join(""),I=(t,e)=>{let r=[];for(let o=1;o<=t.totalPages;o++){let s=o.toString()===t.page.toString()?"current":"";r.push(` <li class="exercises_pagination-item ${s}">
        <a class="page-num" data-page="${o}" data-filter="${e}">${o}</a>
      </li>`)}return r.join("")},u={favorites:"favorites",phrase:"frase"},b=t=>{const e=g(u.favorites);if(!e){alert("Oops! Refresh page");return}const r=e.filter(({_id:o})=>o!==t);f(u.favorites,r)},_=({name:t,burnedCalories:e,bodyPart:r,target:o,_id:s,time:a,gifUrl:n})=>{const i=g(u.favorites)||[];console.log(i);const l=[...i,{name:t,burnedCalories:e,bodyPart:r,target:o,_id:s,time:a,gifUrl:n}];f("favorites",l)},c=document.getElementById("favorite-cards-list"),$=({target:t})=>{if(!t.closest("#remove-favorite-btn"))return;const e=t.closest("[data-id]").dataset.id;console.log(e),b(e)},k=t=>t.map(e=>y(e,!0)).join(""),d=(t="")=>t.length>4&&window.innerWidth<1440?`${t.slice(0,4)} ...`:t,L=(t="")=>{const e=t.split(" ");return t!==""&&e.length>3?e.splice(0,3).join(" ")+" ...":t},S=async t=>{const e=document.querySelector(".scrollbar-container"),r=document.querySelector(".text-nocard-container");try{const o=await g("favorites");if(!o){e==null||e.classList.add("hidden"),r==null||r.classList.remove("hidden");return}r==null||r.classList.add("hidden"),e==null||e.classList.remove("hidden");const s=document.getElementById("exercise-info-text");t.insertAdjacentHTML("beforeend",k(o))}catch(o){console.log(o.message)}};S(c);c==null||c.addEventListener("click",$);const v=document.getElementById("myModal"),x=document.getElementById("openModalBtn"),w=document.getElementById("closeModalBtn"),m=document.querySelector("body");x.addEventListener("click",function(){v.style.display="block",m.classList.add("modal-open")});w.addEventListener("click",function(){v.style.display="none",m.classList.remove("modal-open")});document.addEventListener("DOMContentLoaded",function(){const t=window.location.pathname,e=document.querySelectorAll(".nav_list li");e.forEach(function(r){r.querySelector("a").getAttribute("href")===t&&r.classList.add("nav_item_active")}),document.querySelector(".nav_list li.nav_item_active")||e[0].classList.add("nav_item_active")});export{I as a,y as b,E as c,_ as d,g,b as r};
//# sourceMappingURL=header-cd637621.js.map
