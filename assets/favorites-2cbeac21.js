import{a as l}from"./vendor-85278fa1.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerpolicy&&(a.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?a.credentials="include":t.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(t){if(t.ep)return;t.ep=!0;const a=o(t);fetch(t.href,a)}})();l.defaults.baseURL="https://your-energy.b.goit.study/api/";const w=async({filter:r="",page:e=1,limit:o=12}={})=>{try{return console.log("filter",r),(await l.get(`filters?filter=${r}&page=${e}&limit=${o}`)).data}catch(s){console.error("Error in getFilters:",s)}},v=async({bodypart:r="",muscles:e="",equipment:o="",keyword:s="",page:t=1,limit:a=10}={})=>{try{return(await l.get(`exercises?bodypart=${r}&muscles=${e}&equipment=${o}&keyword=${s}&page=${t}&limit=${a}`)).data}catch(i){console.error("Error in getExercises:",i)}},S=async r=>{try{return(await l.get(`exercises/${r}`)).data}catch(e){console.error("Error in getExerciseId:",e)}},L=async r=>{try{return await l.post("subscription",r)}catch(e){return console.error("Error in subscribe:",e),e.response}},h=r=>r?'<button type="button" class="remove-btn" id="remove-favorite-btn"><svg class="changeble-icon" width="16" height="16"><use href="/oleksii-symbol-defs.svg#icon-trash"></use></svg></button>':'<div class="icon-rating-container"><p class="rating-info-card">4.0</p><svg class="changeble-icon" width="18" height="18"><use href="/oleksii-symbol-defs.svg#icon-star"></use></svg></div>',y=(r,e=!1)=>{const{name:o,burnedCalories:s,bodyPart:t,target:a,_id:i,time:g}=r;return`<li class="favorite-info-card" data-id=${i}>
      ...
      </li>`)}return o.join("")},f=(r,e)=>{try{localStorage.setItem(r,JSON.stringify(e))}catch(o){console.error("Error save localStorage:",o)}},p=r=>{try{const e=localStorage.getItem(r);return e?JSON.parse(e):null}catch(e){return console.error("Error get localStorage:",e),null}},b=r=>{const e=p(KEY_STORAGE.favorites);if(!e){alert("Oops! Refresh page");return}const o=e.filter(({_id:s})=>s!==r);f(KEY_STORAGE.favorites,o)},I=({name:r,burnedCalories:e,bodyPart:o,target:s,_id:t,time:a,gifUrl:i})=>{const m=[...p(KEY_STORAGE.favorites)||[],{name:r,burnedCalories:e,bodyPart:o,target:s,_id:t,time:a,gifUrl:i}];f("favorites",m)},d=document.getElementById("favorite-cards-list"),c=document.querySelector(".text-nocard-container"),n=document.querySelector(".scrollbar-container"),$=({target:r})=>{if(!r.closest("#remove-favorite-btn"))return;const e=r.closest('[data-id="64f389465ae26083f39b17b7"]').dataset.id;console.log(e),b(e)},x=r=>r.map(e=>y(e,!0)).join(""),u=(r="")=>r.length>5&&window.innerWidth<1440?`${r.slice(0,4)}...`:r,E=async r=>{try{const{results:e}=await v();if(console.log(e),e.length===0){n==null||n.classList.add("hidden"),c==null||c.classList.remove("hidden");return}c==null||c.classList.add("hidden"),n==null||n.classList.remove("hidden");const o=document.getElementById("exercise-info-text");r==null||r.insertAdjacentHTML("beforeend",x(e))}catch(e){console.log(e.message)}};E(d);d==null||d.addEventListener("click",$);export{F as a,S as b,C as c,p as d,I as e,w as g,b as r,L as s};
//# sourceMappingURL=favorites-2cbeac21.js.map
