...
<div class="gif-container"><img src='${u}' alt="${o} gif"/>
      ...
      <ul class="card-info-list">
        ...
        <li class="exercises_category-item" data-category="${o}" data-filter="${s}"
        style="
      ...
      </li>`).join(""),I=(r,e)=>{let o=[];for(let s=1;s<=r.totalPages;s++){let t=s.toString()===r.page.toString()?"current":"";o.push(` <li class="exercises_pagination-item ${t}">
        <a class="page-num" data-page="${s}" data-filter="${e}">${s}</a>
      </li>`)}return o.join("")},p=(r,e)=>{try{localStorage.setItem(r,JSON.stringify(e))}catch(o){console.error("Error save localStorage:",o)}},v=r=>{try{const e=localStorage.getItem(r);return e?JSON.parse(e):null}catch(e){return console.error("Error get localStorage:",e),null}},b=r=>{const e=v(KEY_STORAGE.favorites);if(!e){alert("Oops! Refresh page");return}const o=e.filter(({_id:s})=>s!==r);p(KEY_STORAGE.favorites,o)},O=({name:r,burnedCalories:e,bodyPart:o,target:s,_id:t,time:a,gifUrl:i})=>{const u=[...v(KEY_STORAGE.favorites)||[],{name:r,burnedCalories:e,bodyPart:o,target:s,_id:t,time:a,gifUrl:i}];p("favorites",u)},d=document.getElementById("favorite-cards-list"),c=document.querySelector(".text-nocard-container"),n=document.querySelector(".scrollbar-container"),$=({target:r})=>{if(!r.closest("#remove-favorite-btn"))return;const e=r.closest('[data-id="64f389465ae26083f39b17b7"]').dataset.id;console.log(e),b(e)},x=r=>r.map(e=>y(e,!0)).join(""),g=(r="")=>r.length>4&&window.innerWidth<1440?`${r.slice(0,4)} ...`:r,E=(r="")=>{const e=r.split(" ");return r!==""&&e.length>3?e.splice(0,3).join(" ")+" ...":r},k=async r=>{try{const{results:e}=await m();if(e.length===0){n==null||n.classList.add("hidden"),c==null||c.classList.remove("hidden");return}c==null||c.classList.add("hidden"),n==null||n.classList.remove("hidden");const o=document.getElementById("exercise-info-text");r==null||r.insertAdjacentHTML("beforeend",x(e))}catch(e){console.log(e.message)}};k(d);d==null||d.addEventListener("click",$);export{I as a,m as b,C as c,y as d,L as e,v as f,S as g,O as h,b as r,F as s};
//# sourceMappingURL=favorites-361af00e.js.map
